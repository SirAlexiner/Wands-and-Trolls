...
public class LanguageManager {
  ...
  /**
   * <p>getLanguageSelectionBox.</p>
   *
   * @return a {@link javafx.scene.control.ChoiceBox} object
   */
   ...
   * @return a {@link javafx.beans.binding.StringBinding} object
   */
