...
public class FantasyButton extends Button {
  ...
  /**
   * <p>Constructor for FantasyButton.</p>
   *
   * @param stringOrKey a {@link java.lang.String} object
   * @param useResource a boolean
   */
  ...
  /**
   * <p>setFantasyButtonType.</p>
   *
   * @param buttonType a {@link no.ntnu.idatg2001.grp13.gui.elements.util.FantasyButtonType} object
   */
